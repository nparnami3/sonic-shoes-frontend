        ...
        >
            <Wrapper className="h-[60px] flex justify-between items-center text-white">
                ...
                <div className="flex items-center gap-2 text-white">
                    {/* Icon start */}
                    <div className="w-8 left-[260px] md:w-12 flex h-8 md:h-12 rounded-full sm:left-[85px]  justify-center items-center hover:bg-black/[0.05] cursor-pointer relative ">
                    ...
                    {/* Icon start */}
                    <Link href="/cart">
                        <div className="w-8 md:w-12 h-8 md:h-12 rounded-full sm:left-[75px] left-[250px] flex justify-center items-center hover:bg-black/[0.05] cursor-auto sm:cursor-pointer relative">
