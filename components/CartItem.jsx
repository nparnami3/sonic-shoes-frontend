        ...
        <div className="flex py-5 gap-3 md:gap-5 border-b">
            ...
            <div className="w-full flex flex-col">
                <div className="flex flex-col md:flex-row justify-between">
                    {/* PRODUCT TITLE */}
                    <div className="text-lg text-cyan-200 md:text-2xl font-semibold">
                        {p.name}
                    </div>
                    ...
                    {/* PRODUCT PRICE */}
                    <div className="text-sm md:text-md font-bold text-white/[0.8] mt-2">
                        MRP : &#8377;{p.price}
                    </div>
                </div>
                ...
                <div className="flex items-center justify-between mt-4">
                    ...
                    <RiDeleteBin6Line
                        ...
                        className="cursor-pointer text-white/[0.5] hover:text-red-400 text-[16px] md:text-[20px]"
                    />
                </div>
            </div>
        </div>
